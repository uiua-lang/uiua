...
pub fn Optimizations() -> impl IntoView {
    ...
    view! {
        ...
        <table class="bordered-table cell-centered-table">
            ...
            <tr><th><Prim prim=First glyph_only=true/>"/"<Prim prim=Last glyph_only=true/> <Prims prims=[Un, Sort] show_names=true/></th><td><Prims prims=[Un, Sort]/>" then take the "<Prim prim=First/>"/"<Prim prim=Last/></td><td>"Just pick a random row"</td></tr>
        </table>
