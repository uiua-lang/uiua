...
fn prim_inverse(prim: Primitive, span: usize) -> Option<Instr> {
    ...
    Some(match prim {
        ...
        Transpose => Instr::ImplPrim(InvTransposeN(1), span),
...
fn impl_prim_inverse(prim: ImplPrimitive, span: usize) -> Option<Instr> {
    ...
    Some(match prim {
        ...
        TransposeN(n) => Instr::ImplPrim(InvTransposeN(n), span),
        InvTransposeN(1) => Instr::Prim(Transpose, span),
        InvTransposeN(n) => Instr::ImplPrim(TransposeN(n), span),
