...
- [`group ⊕`](https://uiua.org/docs/group) can now take multidimension index arrays
- [`partition ⊜`](https://uiua.org/docs/partition) can now take multidimension marker arrays
