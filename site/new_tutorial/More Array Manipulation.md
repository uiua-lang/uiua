...
This can get a bit unwieldy if an array has a lot of dimensions. You can instead use [numeric subscripts](</new-tutorial/More Argument Manipulation#subscripts>) with [rows]() to specify the rank of the arrays you want to work on.
