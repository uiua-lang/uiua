...
fn TutorialFunctions() -> impl IntoView {
    ...
    view! {
        ...
        <p>"If you wanted to rotate every row of an array backwards by a fixed amount, you could use "<Prim prim=Level/><Prim prim=Water/><Prim prim=Rock/>" (using "<Prim prim=Level/>" will be discussed more in the "<A href="/docs/advancedarray">"Advanced Array Manipulation tutorial"</A>")."</p>
