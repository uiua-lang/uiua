...
impl Value {
    ...
    pub fn as_ints<C: ErrorContext>(
        ...
        let requirement = requirement.unwrap_or("Expected value to be an array of integers");
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_bool(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<bool> {
        let requirement = requirement.unwrap_or("Expected value to be boolean");
        Ok(match self {
            Value::Num(nums) => {
                if nums.rank() > 0 {
                    return Err(
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_nat(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<usize> {
        let requirement = requirement.unwrap_or("Expected value to be a natural number");
        self.as_nat_or_inf(env, Some(requirement))?
    ...
    pub(crate) fn as_nat_or_inf(
        ...
        let requirement =
            requirement.unwrap_or("Expected value to be a natural number or infinity");
        Ok(match self {
            Value::Num(nums) => {
                if nums.rank() > 0 {
                    return Err(
    ...
    pub fn as_int<C: ErrorContext>(
        ...
        let requirement = requirement.unwrap_or("Expected value to be an integer");
        Ok(match self {
            Value::Num(nums) => {
                if nums.rank() > 0 {
                    return Err(
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_num(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<f64> {
        let requirement = requirement.unwrap_or("Expected value to be a number");
        Ok(match self {
            Value::Num(nums) => {
                if nums.rank() > 0 {
                    return Err(
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_nums(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<Vec<f64>> {
        let requirement = requirement.unwrap_or("Expected value to be an array of numbers");
        self.as_number_list(env, requirement)
    }
    ...
    pub fn as_nats<C: ErrorContext>(
        ...
        let requirement = requirement.unwrap_or("Expected value to be an array of natural numbers");
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_bytes(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<Vec<u8>> {
        let requirement = requirement.unwrap_or("Expected value to be array of bytes");
        self.as_number_list(env, requirement)
    }
    /// Attempt to convert the array to a list f u16s
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_u16s(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<Vec<u16>> {
        let requirement =
            requirement.unwrap_or("Expected value to be array of 16-bit unsigned integers");
        self.as_number_list(env, requirement)
    }
    /// Attempt to convert the array to a list of booleans
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_bools(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<Vec<bool>> {
        let requirement = requirement.unwrap_or("Expected value to be array of booleans");
        self.as_number_list(env, requirement)
    }
    ...
    pub fn as_rank_list(
        ...
        let requirement =
            requirement.unwrap_or("Elements of rank list must be integers or infinity");
        self.as_number_list(env, requirement)
    }
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn as_string(&self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<String> {
        let requirement = requirement.unwrap_or("Expected value to be a string");
        match (self, self.rank()) {
            ...
            (Value::Box(boxes), 0) => boxes.data[0].0.as_string(env, Some(requirement)),
    ...
    pub fn as_strings(
        ...
        let requirement = requirement.unwrap_or("Expected value to be a string or list of strings");
        ...
        match (self, self.rank()) {
            ...
            (Value::Box(boxes), 0) => boxes.data[0].0.as_strings(env, Some(requirement)),
            (Value::Box(boxes), 1) => {
                let mut strings = Vec::with_capacity(boxes.row_count());
                for Boxed(val) in &boxes.data {
                    strings.push(val.as_string(env, Some(requirement))?);
                }
                Ok(strings)
            }
            (Value::Box(_), n) => {
    ...
    ///
    /// The `requirement` parameter is used in error messages.
    pub fn into_bytes(self, env: &Uiua, requirement: Option<&'static str>) -> UiuaResult<Vec<u8>> {
        let requirement = requirement.unwrap_or("Expected value to be a list of bytes");
        Ok(match self {
            Value::Byte(a) => {
                if a.rank() != 1 {
